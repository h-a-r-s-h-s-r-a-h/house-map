...
(setq li (+ li 1))
  ...
  (setq group_g (list (list 4 5 7 15) (list 13 8 0 10) (list 1 6 2 14) (list 9 12 11 3)))
  (setq bays (list (list 4 5 7 15) (list 13 8) (list 0 10) (list 1 6 2 14) (list 9 12 11 3)))
  (setq lis nil)
 ...
 ;(setq fitness (- fitness (* (/ elem 12.0) 100.0)))
  ...
  ;(princ "\n")(princ group_g)
          ...
          (if (and (= (rem i 2) 0)(= (rem j 2) 1))
	           (progn
		         (if (and(or (= (nth 0 (nth i group_g))(nth 0 (nth j bays)))(= (nth 0 (nth i group_g))(nth 1 (nth j bays)))) (setq check 0))
			   (progn
			     (setq elem (+ elem 1))
			     (setq lis (reverse (nth j bays)))
			     (setq bays (replace-n lis j bays))
		      ...
		      (if (and (or (= (nth 1 (nth i group_g))(nth 0 (nth j bays)))(= (nth 1 (nth i group_g))(nth 1 (nth j bays)))) (setq check 0))
			   (progn
			     (setq elem (+ elem 1))
			     (setq lis (reverse (nth j bays)))
			     (setq bays (replace-n lis j bays))
		     ...
		     (if (and (or (= (nth 2 (nth i group_g))(nth 3 (nth j bays)))(= (nth 2 (nth i group_g))(nth 2 (nth j bays)))) (setq check 0))
			       (progn
			     (setq elem (+ elem 1))
			     (setq lis (reverse (nth j bays)))
			     (setq bays (replace-n lis j bays))
		     ...
		     (if (and (or (= (nth 3 (nth i group_g))(nth 3 (nth j bays)))(= (nth 3 (nth i group_g))(nth 2 (nth j bays)))) (setq check 0))
			       (progn
			     (setq elem (+ elem 1))
			     (setq lis (reverse (nth j bays)))
			     (setq bays (replace-n lis j bays))
      ...
      (if (and (= (rem i 2) 0)(= (rem j 2) 0))
		     ...
		     (if (and (or (= (nth 3 (nth i group_g))(nth 1 (nth j bays)))(= (nth 3 (nth i group_g))(nth 0 (nth j bays)))) (setq check 0))
			     (progn
			     (setq elem (+ elem 1))
			     (setq lis (reverse (nth j bays)))
			     (setq bays (replace-n lis j bays))
		       ...
		       (if (and (or (= (nth 2 (nth i group_g))(nth 1 (nth j bays)))(= (nth 2 (nth i group_g))(nth 0 (nth j bays)))) (setq check 0))
			     (progn
			     (setq elem (+ elem 1))
			     (setq lis (reverse (nth j bays)))
			     (setq bays (replace-n lis j bays))
		      ...
		      (if (and (or (= (nth 1 (nth i group_g))(nth 2 (nth j bays)))(= (nth 1 (nth i group_g))(nth 3 (nth j bays)))) (setq check 0))
			       (progn
			     (setq elem (+ elem 1))
			     (setq lis (reverse (nth j bays)))
			     (setq bays (replace-n lis j bays))
		      ...
		      (if (and (or (= (nth 0 (nth i group_g))(nth 2 (nth j bays)))(= (nth 0 (nth i group_g))(nth 3 (nth j bays)))) (setq check 0))
			       (progn
			     (setq elem (+ elem 1))
			     (setq lis (reverse (nth j bays)))
			     (setq bays (replace-n lis j bays))
